...
import CellButton from "./components/Button";
...
const App: React.FC = () => {
  ...
  return (
    <div className="App">
      <div>
        <Button variant="contained" onClick={() => startGame(1)}>
          Level 1
        </Button>
        <Button variant="contained">Level 2</Button>
        <Button variant="contained">Level 3</Button>
        <Button variant="contained">Level 4</Button>
      </div>
